...
data_config = {
    "path": "/local/home/am/EX_M/datasets/scRNA/skin",
    "seed": 32,
...
adata = sc.read(data_config['path'] + '/skin_preprocessed.h5ad')
...
val_data.write(data_config['path'] + f'/seed_{random_state}/skin_val.h5ad')
...
transformed_val_data.to_csv(data_config['path'] + f'/seed_{random_state}/skin_val_with_expression{"_highly_variable" if data_config["only_highly_variable"] else ""}.csv', index=False)
...
test_data.write(data_config['path'] + f'/seed_{random_state}/skin_test.h5ad')
...
transformed_test_data.to_csv(data_config['path'] + f'/seed_{random_state}/skin_test_with_expression{"_highly_variable" if data_config["only_highly_variable"] else ""}.csv', index=False)
...
train_data.write(data_config['path'] + f'/seed_{random_state}/skin_train.h5ad')
...
transformed_train_data.to_csv(data_config['path'] + f'/seed_{random_state}/skin_train_with_expression{"_highly_variable" if data_config["only_highly_variable"] else ""}.csv', index=False)
