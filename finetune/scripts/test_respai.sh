...
#     --test_data /local/home/am/EX_M/datasets/scRNA/merged/seed_32/scFoundation/test/bone_marrow_test_processed.h5ad \
...
python ../main.py \
    ...
    --advanced_masking ${advanced_masking} \
    --cross_attention_output_involevment ${cross_attention_output_involevment} \
    --test_data /local/home/am/EX_M/datasets/scRNA/retina/seed_32/scFoundation/test \
    --output_dir ${output_dir} \
    --pretrained_model_dir ${pretrained_model_dir} \
    --frozen_masking_layers ${frozen_masking_layers} \
    --original_model_dir /local/home/am/EX_M/scFoundation/pretrained_model/model.ckpt  \
    ...
    --test_sample_filename "retina_test_sampled" \